...
from .views import (recipe_list, recipe_detail, ingredient_list,
                    ingredient_detail, add_to_favorites,
                    manage_shopping_cart, download_cart,
                    get_short_link, UserViewSet)
...
urlpatterns = [
    ...
    path('recipes/<int:id>/shopping_cart/', manage_shopping_cart,
         name='shopping-cart'),
